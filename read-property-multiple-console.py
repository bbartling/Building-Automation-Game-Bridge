...
$ python3.10 read-property-multiple-console.py 192.168.0.101/24 --debug
> rpm 12345:2 analog-input,1 present-value analog-input,2 present-value analog-input,3 present-value
